  ...
  },
  {
    ...
    sections: [
  ...
  },
      {
        ...
        title: "Locally Advanced Disease (T4 Scenario + Neoadjuvant Logic)",
        content: [
          "Board Clarification: Nipple retraction ALONE does NOT automatically mean T4.",
          "T4 requires true skin or chest wall involvement:",
          "• T4a – chest wall invasion",
          "• T4b – skin ulceration, satellite nodules, or peau d’orange",
          "• T4c – both chest wall and skin",
          "• T4d – inflammatory carcinoma",
          "",
          "Skin tethering ≠ dermal invasion (major board trap).",
          "",
          "If confirmed T4N0M0 (Stage IIIB):",
          "• Complete metastatic workup FIRST (CT chest-abdomen ± bone scan / PET).",
          "• Standard approach = neoadjuvant systemic therapy.",
          "",
          "ER+ / HER2− options:",
          "• Neoadjuvant chemotherapy (anthracycline → taxane regimen)",
          "OR",
          "• Neoadjuvant endocrine therapy (postmenopausal: aromatase inhibitor e.g., Letrozole 2.5 mg daily) in selected cases.",
          "",
          "After response → Modified Radical Mastectomy.",
          "Post-mastectomy radiation is mandatory for T4 disease.",
          "Adjuvant endocrine therapy continues long-term (5–10 years).",
          "",
          "Board Oral Defense Structure:",
          "1) Confirm true T4 criteria (skin invasion vs simple retraction).",
          "2) Complete systemic staging.",
          "3) Neoadjuvant systemic therapy.",
          "4) Definitive surgery (MRM).",
          "5) Radiation + endocrine therapy.",
        ],
        qna: [
          {
            id: "t4-q1",
            question: "Nipple retraction without ulceration or peau d’orange automatically makes a tumor T4.",
            choices: [
              { id: "a", text: "True" },
              { id: "b", text: "False" },
            ...
            answerId: "b",
            explanation:
              "Nipple retraction alone does NOT equal T4. True T4 requires skin or chest wall invasion.",
          },
          {
            id: "t4-q2",
            question: "Confirmed T4N0M0 ER+ / HER2− breast cancer best initial step is:",
            choices: [
              { id: "a", text: "Immediate mastectomy" },
              { id: "b", text: "Neoadjuvant systemic therapy" },
              { id: "c", text: "Sentinel node biopsy only" },
              { id: "d", text: "Observation and endocrine therapy alone" },
            ],
            answerId: "b",
            explanation:
              "Locally advanced (T4) breast cancer is treated with neoadjuvant systemic therapy before definitive surgery.",
          },
        ],
      },
];