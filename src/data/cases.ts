  ...
  },
{
  id: "mrm",
  category: "BREAST",
  title: "BREAST — Modified Radical Mastectomy (MRM)",
  subtitle:
    "Indications → Axillary anatomy → Sentinel vs ALND traps → Board pearls → Oral defense",
  priorityOneLiner:
    "Oncologic control of breast malignancy with complete breast removal + Level I–II axillary dissection while preserving pectoralis major.",
  sections: [
    {
      id: "indications",
      ...
      content: [
        ...
        "• Failed breast-conserving surgery",
        "• Patient preference",
        "• Inflammatory breast cancer (after neoadjuvant therapy)",
        "",
        "Absolute Contraindication:",
        "• Distant metastasis where surgery does not improve survival (unless palliative)",
        "",
        "Board trap:",
        "• T4 tumor after neoadjuvant therapy is NOT automatically unresectable.",
      ],
      qna: [
        {
          id: "mrm-q1",
          question: "Standard MRM removes which axillary levels?",
          choices: [
            { id: "a", text: "Level I only" },
            { id: "b", text: "Level I and II" },
            { id: "c", text: "Level I, II and III routinely" },
            { id: "d", text: "Sentinel node only" },
          ],
          answerId: "b",
          explanation:
            "MRM = total mastectomy + Level I–II ALND. Level III is NOT routine; do only if gross apical disease/suspicious nodes.",
        },
      ],
    },

    {
      ...
      content: [
        ...
        "",
        "Standard MRM removes Level I and II.",
        "Level III dissection only if gross disease.",
        "",
        "Board trap:",
        "• Routine Level III dissection increases lymphedema risk.",
      ],
      qna: [],
    },
    ...
    {
      id: "sentinel-vs-alnd",
      title: "Sentinel Node vs ALND (Board Traps)",
      content: [
        "Sentinel node biopsy indicated in:",
        ...
        "",
        "Board pearls:",
        "• 1–2 positive sentinel nodes + breast-conserving therapy → may omit ALND (Z0011 logic).",
        "• Sentinel NOT recommended in inflammatory breast cancer.",
      ],
      qna: [],
    },
    ...
    {
      id: "receptors",
      title: "ER/PR/HER2 Board Pearls",
      content: [
        "ER/PR positive → endocrine therapy indicated.",
        "HER2 positive → Trastuzumab for 1 year (cardiotoxicity risk).",
        "Triple negative → chemotherapy driven.",
        "",
        "Numeric traps:",
    ...
    {
      id: "postop",
      title: "Drain Management + Post-op Complications",
      content: [
        "Drain removal when output < 30 mL per 24 hrs (typical board number).",
        "",
        "Early complications:",
        "• Hematoma",
        "• Seroma",
        ...
        "",
        "Late complications:",
        "• Lymphedema (risk increases with ALND)",
    ...
    {
      id: "oral-defense",
      title: "Oral Defense Script",
      content: [
        "1) Confirm staging and receptor status.",
        "2) State surgical plan: MRM = total mastectomy + Level I–II ALND.",
        "3) Discuss need for adjuvant therapy based on nodes + receptor status.",
        "4) Mention lymphedema counseling + drain criteria.",
      ],
      qna: [],
    },
  ],
